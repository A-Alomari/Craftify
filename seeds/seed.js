...
async function seed() {
  ...
  try {
    ...
    { artisan_id:art1, category_id:catId('home-decor'), name:'Hand-Painted Decorative Plate', description:'Large 14" wall plate with hand-painted floral motifs in cobalt blue. Includes wall mounting hardware.', price:95.00, stock:5, images:'["https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=600&q=80"]', featured:1, status:'approved', weight:640, tags:'ceramic,hand-painted,wall-art,cobalt' },
    ...
    { artisan_id:art3, category_id:catId('glassware'), name:'Glass Drinking Set', description:'Set of 4 hand-blown tumblers with subtle blue tint. Each glass approximately 10oz capacity.', price:92.00, stock:8, images:'["https://images.unsplash.com/photo-1577401239170-897942555fb3?w=600&q=80"]', featured:0, status:'approved', weight:760, tags:'glass,blown-glass,tumblers,set-of-4,blue' },
    { artisan_id:art3, category_id:catId('home-decor'), name:'Glass Wind Chime', description:'Delicate wind chime made from hand-cut stained glass pieces. Produces gentle tinkling sounds.', price:55.00, stock:12, images:'["https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=600&q=80"]', featured:0, status:'approved', weight:340, tags:'glass,stained-glass,wind-chime,outdoor' },
    ...
    { artisan_id:art4, category_id:catId('jewelry'), name:'Moonstone Stacker Rings', description:'Set of 3 thin sterling silver stacking rings, one set with a genuine moonstone cabochon.', price:98.00, stock:8, images:'["https://images.unsplash.com/photo-1515562141589-67f0d569b6c9?w=600&q=80"]', featured:0, status:'approved', weight:9, tags:'sterling-silver,moonstone,stacking-rings,set-of-3' },
    ...
    { artisan_id:art6, category_id:catId('textiles'), name:'Batik Print Table Runner', description:'Contemporary batik-print cotton table runner in indigo and cream. Hand-waxed and dyed using traditional techniques. 180x40cm.', price:55.00, stock:18, images:'["https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80"]', featured:0, status:'approved', weight:220, tags:'batik,cotton,indigo,table-runner,wax-resist' },
    ...
    { artisan_id:art2, category_id:catId('woodwork'), name:'Hand-Planed Oak Notebook Stand', description:'Laptop and notebook stand hand-planed from solid red oak. Adjustable angle groove. Desk-top size 28x22cm.', price:68.00, stock:8, images:'["https://images.unsplash.com/photo-1503602642458-232111445657?w=600&q=80"]', featured:0, status:'approved', weight:480, tags:'oak,notebook-stand,hand-planed,desk-accessory' },
    { artisan_id:art2, category_id:catId('woodwork'), name:'Walnut Cheese Board', description:'Large serving board in solid black walnut with integrated handle and juice groove. 40x20cm. Finished with beeswax.', price:72.00, stock:10, images:'["https://images.unsplash.com/photo-1588165171080-c89acfa5ee83?w=600&q=80"]', featured:0, status:'approved', weight:820, tags:'walnut,cheese-board,beeswax,serving,kitchen' },
