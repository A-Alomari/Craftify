...
async function seed() {
  ...
  try {
    ...
    { artisan_id:art5, category_id:catId('home-decor'), name:'Braided Leather Plant Hanger', description:'Hand-braided leather plant hanger with brass ring and adjustable drop length. Designed for 6" to 8" pots.', price:49.00, stock:14, images:'["https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=600&q=80"]', featured:0, status:'approved' }
  ];
